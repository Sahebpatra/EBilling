<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValidateOTP.aspx.cs" Inherits="ValidateOTP" %>
...
<body>
      ...
      <section class="panel panel-default bg-white m-t-lg">
        ...
        <form id="Form1" runat="server" class="panel-body wrapper-lg">
          ...
          <div class="form-group">
            ...
            <asp:TextBox runat="server" id="txtOTP" placeholder="Enter OTP" maxlength="6" TextMode="Number" class="form-control input-lg" ></asp:TextBox>
          </div>          
          <asp:Button ID="btnValidateOTP" runat="server" OnClick="btnValidateOTP_Click" CssClass="btn btn-facebook btn-block m-b-sm" Text="Validate OTP" />
                    <asp:Button ID="btnResendOTP" runat="server" OnClick="btnResendOTP_Click" CssClass="btn btn-facebook btn-block m-b-sm" Text="Resend OTP" />
    ...
    <div class="text-center padder">
      <p>
        <small style="color: azure;">&copy Copyright By 2021 MI WINGO MARKETING PRIVATE LIMITED.<br />
